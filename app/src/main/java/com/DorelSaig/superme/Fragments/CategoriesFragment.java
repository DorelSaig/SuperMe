...
public class CategoriesFragment extends Fragment {
    ...
    /**
     * Listen and triggers operation whenever the categories list - Gets new category added, modified or removed in firebase
     */
    private void itemsArrayChangeListener() {

        db.collection(Constants.KEY_CATEGORIES).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
